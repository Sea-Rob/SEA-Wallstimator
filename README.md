...
Current state: **walking skeleton + Reference Marker supply flow + still-frame rectification + recorded pan with live capture coaching (guided-record tier)**. The capture page walks the Homeowner through:
